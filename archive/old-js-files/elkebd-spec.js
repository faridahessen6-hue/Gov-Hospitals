    ...
    const specialties = [
        {
            id: 'elkebd',
            title: 'Hepatitis',
            arTitle: 'التهاب الكبد',
            icon: 'activity',
            color: '#0d6efd',
            description: 'Comprehensive diagnosis and treatment for all types of hepatitis including A, B, C, D, and E.',
            url: 'elkebd-hospital.html?specialty=hepatitis'
        },
        {
            id: 'elkebd',
            ...
            icon: 'heart-pulse',
            color: '#6610f2',
            description: 'Advanced care and management for liver cirrhosis and its complications.',
            url: 'elkebd-hospital.html?specialty=cirrhosis'
        },
        {
            id: 'elkebd',
            title: 'Fatty Liver Disease',
            arTitle: 'الكبد الدهني',
            icon: 'droplet',
            color: '#198754',
            description: 'Specialized treatment plans for non-alcoholic and alcoholic fatty liver disease.',
            url: 'elkebd-hospital.html?specialty=fatty-liver'
        },
        {
            id: 'elkebd',
            title: 'Liver Cancer',
            ...
            icon: 'activity',
            color: '#dc3545',
            description: 'Multidisciplinary approach to liver cancer diagnosis, treatment, and follow-up care.',
            url: 'elkebd-hospital.html?specialty=liver-cancer'
        },
        {
            id: 'elkebd',
            title: 'Liver Failure',
            ...
            icon: 'heart-pulse',
            color: '#fd7e14',
            description: 'Comprehensive management of acute and chronic liver failure, including transplant evaluation.',
            url: 'elkebd-hospital.html?specialty=liver-failure'
        }
    ];
