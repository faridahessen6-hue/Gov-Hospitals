    ...
    const specialties = [
        {
            ...
            url: 'hospital.html?name=elgeldia&specialty=acne'
        },
        {
            title: 'Eczema',
            arTitle: 'الإكزيما',
            ...
            url: 'hospital.html?name=elgeldia&specialty=eczema'
        },
        {
            title: 'Psoriasis',
            arTitle: 'الصدفية',
            ...
            url: 'hospital.html?name=elgeldia&specialty=psoriasis'
        },
        {
            title: 'Vitiligo',
            arTitle: 'البهاق',
            ...
            url: 'hospital.html?name=elgeldia&specialty=vitiligo'
        },
        {
            title: 'Urticaria',
            arTitle: 'الأرتيكاريا',
            ...
            url: 'hospital.html?name=elgeldia&specialty=urticaria'
        },
        {
            ...
            url: 'hospital.html?name=elgeldia&specialty=fungal-infections'
        },
        {
            ...
            url: 'hospital.html?name=elgeldia&specialty=bacterial-infections'
        },
        {
            ...
            url: 'hospital.html?name=elgeldia&specialty=viral-infections'
        },
        {
            ...
            url: 'hospital.html?name=elgeldia&specialty=contact-dermatitis'
        },
        {
            title: 'Rosacea',
            arTitle: 'العد الوردي',
            ...
            url: 'hospital.html?name=elgeldia&specialty=rosacea'
        },
        {
            title: 'Alopecia',
            arTitle: 'الثعلبة',
            ...
            url: 'hospital.html?name=elgeldia&specialty=alopecia'
        },
        {
            title: 'Melasma',
            arTitle: 'الكلف',
            ...
            url: 'hospital.html?name=elgeldia&specialty=melasma'
        },
        {
            title: 'Scabies',
            arTitle: 'الجرب',
            ...
            url: 'hospital.html?name=elgeldia&specialty=scabies'
        },
        {
            title: 'Lupus',
            ...
            url: 'hospital.html?name=elgeldia&specialty=lupus'
        },
        {
            title: 'Skin Cancer',
            arTitle: 'سرطان الجلد',
            ...
            url: 'hospital.html?name=elgeldia&specialty=skin-cancer'
        }
    ];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const loadWrappers = () => new Promise((resolve) => {
        ...
        hs.src = 'components/common/header.js';
        hs.onload = () => {
            const fs = document.createElement('script');
            fs.src = 'components/common/footer.js';
            fs.onload = resolve;
