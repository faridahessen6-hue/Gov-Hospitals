// Simplified teen.js - booking logic handled by bootstrap.js routing
// This file now only provides minimal page-specific overrides
// The actual booking functionality is provided by src/pages/booking/booking-core.js via src/bootstrap.js

// Simple initialization with minimal styling
document.addEventListener('DOMContentLoaded', function() {
    // Any teen-specific customizations can go here
    console.log('Teen booking page initialized - using shared booking core');
});
...
window.onload = function() {
    ...
    // Header and footer are mounted by shared wrappers (components/common/header.js, components/common/footer.js)
...
function showConfirmationMessage(services, paymentMethod) {
    ...
    messageDiv.innerHTML = `
        ...
        <div class="ar-message" style="opacity: 0; transition: opacity 1s ease-in-out 1.5s;">
            <p class="mb-0">تمام تم تاكيد الحجز يوم السبت من 12-10</p>
        </div>
        <hr>
