...
function createSpecialtyCards() {
    const specialties = [
        { 
            ...
            nameAr: 'أمراض القلب', 
            icon: 'heart-pulse',
            url: 'hospital.html?name=al3am&specialty=cardiology'
        },
        { 
            name: 'Neurology', 
            nameAr: 'طب الأعصاب', 
            icon: 'brain',
            url: 'hospital.html?name=al3am&specialty=neurology'
        },
        { 
            name: 'Orthopedics', 
            nameAr: 'جراحة العظام', 
            icon: 'bone',
            url: 'hospital.html?name=al3am&specialty=orthopedics'
        },
        { 
            name: 'Pediatrics', 
            nameAr: 'طب الأطفال', 
            icon: 'baby',
            url: 'hospital.html?name=al3am&specialty=pediatrics'
        },
        { 
            name: 'Dermatology', 
            nameAr: 'الأمراض الجلدية', 
            icon: 'bandaid',
            url: 'hospital.html?name=al3am&specialty=dermatology'
        },
        { 
            name: 'Ophthalmology', 
            nameAr: 'طب العيون', 
            icon: 'eye',
            url: 'hospital.html?name=al3am&specialty=ophthalmology'
        },
        { 
            name: 'ENT', 
            nameAr: 'أنف وأذن وحنجرة', 
            icon: 'ear',
            url: 'hospital.html?name=al3am&specialty=ent'
        },
        { 
            name: 'Dentistry', 
            nameAr: 'طب الأسنان', 
            icon: 'tooth',
            url: 'hospital.html?name=al3am&specialty=dentistry'
        },
        { 
            name: 'Gynecology', 
            nameAr: 'طب النساء', 
            icon: 'gender-female',
            url: 'hospital.html?name=al3am&specialty=gynecology'
        },
        { 
            name: 'Operations', 
            nameAr: 'عمليات', 
            icon: 'scissors',
            url: 'hospital.html?name=al3am&specialty=operations'
        },
        { 
            name: 'Pharmacy', 
            nameAr: 'صيدلية', 
            icon: 'capsule',
            url: 'hospital.html?name=al3am&specialty=pharmacy'
        },
        { 
            name: 'Focussed Care', 
            nameAr: 'رعاية مركزة', 
            icon: 'heart-pulse',
            url: 'hospital.html?name=al3am&specialty=focussed-care'
        },
        { 
            name: 'X-Ray', 
            nameAr: 'أشعة X', 
            icon: 'radioactive',
            url: 'hospital.html?name=al3am&specialty=xray'
        },
        { 
            name: 'Laboratory', 
            nameAr: 'معمل', 
            icon: 'microscope',
            url: 'hospital.html?name=al3am&specialty=laboratory'
        }
    ];
