...
const routes = {
  ...
  'ask': async () => {
    const { initAskChat } = await import('../components/ui/chat-core.js');
    initAskChat();
  },
  'review': async () => {
    const { initReviewChat } = await import('../components/ui/chat-core.js');
    initReviewChat();
  },
  'about': async () => {
    const { typeWriter } = await import('../components/ui/typewriter.js');
